...
BoundingDataArray=[]
BoundingDataArray.append(['Name','string','小王',1])
...
wenjian=tkinter.Menu(MainMenu,tearoff = 0)
wenjian.add_command(label="打开",command=NameInput_cmd.Menu_打开)
MainMenu.add_cascade(label="文件",menu=wenjian)
MainMenu.add_command(label="操作",command=NameInput_cmd.Menu_操作)
