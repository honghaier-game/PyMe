...
class  DbList:
    def __init__(self,root,isTKroot = True):
        ...
        Button_10_Ft=tkinter.font.Font(family='System', size=15,weight='bold',slant='roman',underline=0,overstrike=0)
        ...
        Button_13_Ft=tkinter.font.Font(family='System', size=15,weight='bold',slant='roman',underline=0,overstrike=0)
        ...
        Button_14_Ft=tkinter.font.Font(family='System', size=15,weight='bold',slant='roman',underline=0,overstrike=0)
